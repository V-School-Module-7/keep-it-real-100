...
import sexuality from "../images/sexuality_final.svg"
...
const gameCatagories = [
    ...
    {   
        ...
        questions: [
           ...
           'Someone wrote in an article “Some of us are dealing with unprecedented grief. We are broken with pain and invalidated anger. We are dealing with unanswerable grief. We are suffering.” Do you resonate with this? Please share your comfort level.',
    ...
    {   
        ...
        questions: [
            ...
            'INNOCENCE: All players, draw a picture of innocence. Beginning with the person who chose this interaction, share your drawing with the other players and say as much as you feel comfortable with about what your drawing means to you.',
            ...
            'PASSION: All players, draw a picture of passion. Beginning with the person who chose this interaction, share your drawing with the other players and say as much as you feel comfortable with about what your drawing means to you.',
    ...
    {   
        ...
        questions: [
            ...
            'Tell us a little about your culture and ethnicity. What are your favorite things about it? What don\'t you like? What do you think needs changing?  (For Example: homophobia in certain cultures, colorism, exclusivity)',
    ...
    {   
        ...
        questions: [
            ...
            'LOVE POTION: Create a love potion that works every time! Beginning with the Leader of this turn, add an ingredient to this concoction, and explain why it must be included. (For example: lavender oil - to relax and calm the senses, Ginger - to add some spice, etc.)',
            ...
            'ANIMAL GUIDE: What animal do you most relate to? (for example: Jaguar, Bear, Dog, Elephant, Lion, Cat). Beginning with the Leader of this turn, each player identify your animal, and tell us what qualities they have that make you feel you can relate to them, and why.',
            ...
            'ALL KINDS OF ADVICE: Beginning with the Leader, each player is seeking advice. Propose a question to the other players on anything you choose (real or imaginary). The other players are then to give you Good advice, Bad advice and awful advice. You choose what to listen to!',
    ...
    {   
        ...
        questions: [
           ...
           '“There\'s definitely a dangerous feeling when you\'re in love...It\'s giving your heart to someone else and knowing that they have control over your feelings. I know for me, who always tries to be so tough, that\'s the dangerous thing."     - Beyonce Knowles',
    ...
    {   
        ...
        questions: [
           ...
           'If you use drugs or alcohol, do you think your use affects your family or friends? Please share your thoughts on this.', 
    ...
    {   
        ...
        questions: [
            ...
            'Has anything in your personal and/or professional life changed to respond to or to accommodate the overall recent acknowledgement of the societal challenges we face?',
